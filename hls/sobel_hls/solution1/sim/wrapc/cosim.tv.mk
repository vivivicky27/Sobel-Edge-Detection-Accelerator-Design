...
AUTOPILOT_ROOT := F:/Xilinx/Vitis_HLS/2024.1
...
ifndef AP_GCC_PATH
  AP_GCC_PATH := F:/Xilinx/Vitis_HLS/2024.1/tps/win64/msys64/mingw64/bin
endif
AUTOPILOT_TOOL = ${AUTOPILOT_ROOT}/${AUTOPILOT_MACH}/tools
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
  AP_CLANG_PATH := F:/Xilinx/Vitis_HLS/2024.1/vcxx/libexec/
TOOLCHAIN += --sysroot=F:/Xilinx/Vitis_HLS/2024.1/tps/mingw/10.0.0/win64.o/nt
LFLAG += --sysroot=F:/Xilinx/Vitis_HLS/2024.1/tps/mingw/10.0.0/win64.o/nt
...
$(ObjDir)/sobel_tb.cpp_pre.cpp.tb.o : sobel_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling sobel_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/sobel_accel.cpp_pre.cpp.tb.o : sobel_accel.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling sobel_accel.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
