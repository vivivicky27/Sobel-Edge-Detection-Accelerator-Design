...
# 
# ==============================================================
set ::env(PATH) "F:/Xilinx/Vitis_HLS/2024.1/win64/tools/fpo_v7_1;$::env(Path)"
set ::env(PATH) "F:/Xilinx/Vitis_HLS/2024.1/win64/tools/fft_v9_1;$::env(Path)"
set ::env(PATH) "F:/Xilinx/Vitis_HLS/2024.1/win64/tools/fir_v7_0;$::env(Path)"
set ::env(PATH) "F:/Xilinx/Vitis_HLS/2024.1/win64/tools/dds_v6_0;$::env(Path)"
set ::env(PATH) "F:/Xilinx/Vitis_HLS/2024.1/tps/mingw/10.0.0/win64.o/nt/bin;$::env(Path)"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sobel_accel.autotvin.dat"
	set constFileTvOut       "sobel_accel.autotvout.dat"
	set constFileHdlTvIn     "sobel_accel.autohdltvin.dat"
	set constFileHdlTvOut    "sobel_accel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
