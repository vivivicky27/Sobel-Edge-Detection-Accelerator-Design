...
if {[file isfile sobel_accel.autotvin.dat]} {
	file delete -force sobel_accel.autotvin.dat
}

if {[file isfile sobel_accel.autotvout.dat]} {
	file delete -force sobel_accel.autotvout.dat
}
